...
/**
 * This class is a Spring Data JPA repository for Member entities.
 * It provides methods to find members by ID, email, and to retrieve all members ordered by name.
 */
@Repository
