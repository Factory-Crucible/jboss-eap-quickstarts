 ...
 * This interface replaces the original JBoss EAP MemberRepository class that used EntityManager directly.
 * Spring Data JPA automatically provides implementations for the declared methods.
 */
@Repository
